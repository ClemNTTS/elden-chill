...
export const TINTS = {
  ash: {
    dark: [0x2a, 0x28, 0x24],
    mid: [0x5e, 0x59, 0x4e],
    light: [0x9d, 0x95, 0x82],
  },
  crimson: {
    dark: [0x38, 0x10, 0x12],
    mid: [0x7e, 0x22, 0x22],
    light: [0xc0, 0x53, 0x45],
  },
  rot: {
    dark: [0x2b, 0x30, 0x0e],
    mid: [0x63, 0x6d, 0x1d],
    light: [0xa8, 0xb2, 0x40],
  },
  gold: {
    dark: [0x3d, 0x2c, 0x0d],
    mid: [0x8c, 0x67, 0x1d],
    light: [0xd8, 0xb2, 0x50],
  },
  frost: {
    dark: [0x18, 0x33, 0x3c],
    mid: [0x3c, 0x76, 0x84],
    light: [0x8f, 0xc7, 0xd4],
  },
  glint: {
    dark: [0x1c, 0x25, 0x48],
    mid: [0x3f, 0x53, 0x93],
    light: [0x88, 0x9d, 0xdd],
  },
  silver: {
    dark: [0x33, 0x36, 0x3b],
    mid: [0x74, 0x7b, 0x84],
    light: [0xc6, 0xcd, 0xd6],
  },
  verdant: {
    dark: [0x20, 0x30, 0x1c],
    mid: [0x4a, 0x68, 0x3a],
    light: [0x8c, 0xac, 0x68],
  },
  ember: {
    dark: [0x40, 0x1a, 0x0a],
    mid: [0x93, 0x42, 0x14],
    light: [0xe0, 0x8b, 0x3a],
  },
  ...
  bloom: {
    dark: [0x4a, 0x12, 0x24],
    mid: [0x9c, 0x2b, 0x45],
    light: [0xe0, 0x6c, 0x84],
  },
  bone: {
    dark: [0x4a, 0x44, 0x36],
    mid: [0x8f, 0x85, 0x70],
    light: [0xd8, 0xcf, 0xb6],
  },
  void: {
    dark: [0x1e, 0x14, 0x33],
    mid: [0x45, 0x2e, 0x70],
    light: [0x8a, 0x6c, 0xc4],
  },
  radiant: {
    dark: [0x5c, 0x4c, 0x1a],
    mid: [0xb8, 0x9c, 0x3c],
    light: [0xf5, 0xe4, 0x9a],
  },
};
...
export const auditMonsterVisuals = (knownArchetypes = []) => {
  ...
  Object.entries(VISUALS).forEach(([id, [archetype, tint]]) => {
    ...
    buckets
      .get(key)
      .push({ id, name: monster.name, emblem: EMBLEMS[id] || null });
  });
