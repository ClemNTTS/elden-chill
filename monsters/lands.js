...
export const LANDS_MONSTERS = {
  ...
  godskin_apostle: {
    ...
    runes: 42000,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 45 },
  ...
  elemer_briar: {
    ...
    runes: 53000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 55 },
    onHitEffect: { id: "THORNS", duration: 3, chance: 0.4 },
    hasSecondPhase: true,
  ...
  rykard_lord_blasphemy: {
    ...
    runes: 109000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 130 },
  ...
  catacomb_burnt_spirit: {
    ...
    runes: 167000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 140 },
  ...
  malenia_blade: {
    ...
    runes: 262000,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 160 },
    onHitEffect: { id: "SCARLET_ROT", duration: 4, chance: 0.5 },
    hasSecondPhase: true,
    thresholdForPhase2: 0.5,
  ...
  ash_gideon_ozz: {
    ...
    runes: 91200,
    isRare: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 110 },
  ...
  hoarah_loux: {
    ...
    runes: 360000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 220 },
  ...
  throne_order_fragment: {
    ...
    armor: 240,
    runes: 84700,
    specificStats: { attacksPerTurn: 2, splashDamage: 120 },
    onHitEffect: { id: "MADNESS", duration: 3, chance: 0.4 },
  },
  throne_radagon: {
    ...
    runes: 104900,
    isRare: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 150 },
  ...
  elden_beast: {
    ...
    runes: 413000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 260 },
  ...
  jarburg_great_jar: {
    ...
    runes: 13000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 20 },
  ...
  evergaol_fortissax: {
    ...
    runes: 69300,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 150 },
  ...
  evergaol_astel: {
    ...
    runes: 71600,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 170 },
  ...
  evergaol_ancient_dragon: {
    ...
    runes: 82100,
    isRare: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 160 },
  ...
  evergaol_nameless_champion: {
    ...
    runes: 323000,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 200 },
