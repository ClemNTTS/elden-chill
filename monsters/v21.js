export const V21_MONSTERS = {
  ...
  gelmir_hexmage: {
    ...
    armor: 165,
    runes: 24000,
    specificStats: { attacksPerTurn: 2, splashDamage: 40 },
  ...
  praetor_fragment: {
    ...
    runes: 132000,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 85 },
  ...
  fire_giant_shard: {
    ...
    runes: 188000,
    isBoss: true,
    specificStats: { attacksPerTurn: 1, splashDamage: 100 },
  ...
  azula_tempest_avatar: {
    ...
    runes: 255000,
    isBoss: true,
    specificStats: { attacksPerTurn: 2, splashDamage: 135, critChance: 0.12 },
