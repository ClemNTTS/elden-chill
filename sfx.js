...
const SOUNDS = {
  ...
  ash: {
    file: "Musical Effects/8_bit_chime_quick.wav",
    volume: 0.6,
    minGap: 300,
  },
  ...
  bossDown: {
    file: "Musical Effects/brass_chime_positive.wav",
    volume: 0.8,
    minGap: 1500,
  },
  ...
  event: {
    file: "Musical Effects/8_bit_mystery.wav",
    volume: 0.7,
    minGap: 1200,
  },
  death: {
    file: "Musical Effects/8_bit_defeated.wav",
    volume: 0.7,
    minGap: 1500,
  },
};
